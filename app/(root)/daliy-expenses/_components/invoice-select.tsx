...
import { Invoice } from "../../purchase/_type";
import { deleteEmptyInvoice } from "../../purchase/_actions";
...
function InvoiceSelectExpenses({ unFinishInvoice }: Props) {
...
export default InvoiceSelectExpenses;
